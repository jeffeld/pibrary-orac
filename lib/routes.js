...
module.exports = function (app) {
    ...
    app.put(apiV1Path + '/stock/:itemId/:itemCode/:addedby', stock.putStock);
    ...
    app.put (apiV1Path + '/members/:memberId', apiV1.putMember);

    // Loan routes

    app.put(apiV1Path + '/lend/:stockCode/:membershipCode', stock.lendStock);
    app.put(apiV1Path + '/return/:stockCode', stock.returnStock);
